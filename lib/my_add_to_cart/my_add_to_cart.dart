...
class _AddToCartButtonState extends State<AddToCartButton>
  ...
  Widget _buildFirst(BuildContext context) {
    ...
    final double height =
        max(borderRadius.topLeft.y, borderRadius.topRight.y) + max(borderRadius.bottomLeft.y, borderRadius.bottomRight.y);
              ...
              Container(
                ...
                child: FadeTransition(
                  ...
                  child: _RunningTrolley(
                    ...
                    streetLineColor: widget.streetLineColor ,
...
double _convertDegToRad(double deg) => deg * pi / 180.0;