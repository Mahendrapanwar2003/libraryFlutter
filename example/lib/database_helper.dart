...
class DatabaseHelper {
  ...
  Future<void> createDatabase({required Database? db}) async {
    ...
    await db?.execute(
        'CREATE TABLE IF NOT EXISTS ${DatabaseConst.tableName}(${DatabaseConst.columnId} ${DatabaseConst.idType}, ${DatabaseConst.columnName} ${DatabaseConst.textType}, ${DatabaseConst.columnAge} ${DatabaseConst.intType})');
  }
}
